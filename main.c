	...
	do
		{
			...
			switch (desicionMain) {
				...
				case 7:
					...
					break;
				case 8:
					utn_getNumero(&desicion, "10) Color de barbijo que se compró mas veces.\n11) Cantidad de compras pendientes.\n12) Compra con “precio por unidad” mas bajo.\n"
							"13) Cliente con más compras pagadas.\n14) Cliente con más compras pendientes.\n15) Lista de compras pendientes de pago con información de la compra y del cliente.\n",
